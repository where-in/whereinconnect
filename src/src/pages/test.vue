          ...
          <div class="AuthorizeForm SignForm" v-if="AuthorizeForm">
            <div class="Avatars">
              <div class="Avatar-container">
                <span class="Avatar" style="height: 40px; width: 40px;">
                  <img src="https://steemitimages.com/40x40/http://newappaz.oss-cn-hongkong.aliyuncs.com/wherein_images/cus_head/e3e5422c46c74b47995380d2368b4204.png" alt="图标"/>
                </span>
              </div>
              <div class="Avatar-link"></div>
              <div class="Avatar-container"><img src="https://steemitimages.com/40x40/http://newappaz.oss-cn-hongkong.aliyuncs.com/wherein_images/cus_head/e3e5422c46c74b47995380d2368b4204.png" alt="图标"/></div>
            </div>
            <p>
              <font>
                <font style="vertical-align: inherit;">
                  ...
                  <b>
                    <span><font style="vertical-align: inherit;">发布(posting)</font></span>
                  </b>
            ...
            <ul class="authorize-operations">
              <li v-for="item in ScopeArray" :key="item.text">
                ...
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{item.text}}</font></font>
                <!-- /react-text -->
              </li>
            </ul>
            <mu-button color="primary" @click="toauth">继续</mu-button>
          </div>
          <mu-form v-else ref="addRoomForm" :model="loginForm" class="SignForm" label-position="left">
            <h5>
              <span>登录</span>
            </h5>
            <p>
            ...
            >
              ...
              <mu-flex class="loadingWrap">
                ...
                <mu-icon v-else-if="loadStatus==1" value="rotate_right" color="blue" class="customLoading"></mu-icon>
              </mu-flex>
            ...
            <mu-button color="primary"  @click="auth" :disabeld="!formLoading">
              <mu-icon left v-if="formLoading" value="rotate_right" color="white" class="customLoading"></mu-icon>
              登录
            </mu-button>
          </mu-form>
        </div>
